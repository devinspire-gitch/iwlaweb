<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="DesWeb.Details" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">  
                    <h1 class="text-uppercase text-center" style="font-family: Acme, sans-serif;color: rgb(3,41,79);">PARTNER PROFILE</h1>
                    </div>
                <div class="col-lg-4">
                                    ...
                                    <h2><asp:Label runat="server" ID="lblName"></asp:Label></h2>
                                               ...
                                               <p>
                                                  ...
                                                  <span> <asp:Label runat="server" ID="lblPhone"></asp:Label></span><br />
                                                    ...
                                                    <asp:HyperLink id="lnkWebSite" 
                 
                  NavigateUrl="https://www.iwla.com/" CssClass="website"
                  Text=""
                  Target="_new"
                  runat="server"/> 
                                                   <a  target='_blank' class='website' href=' <%# WebSite %>'> <%# WebSite %></a>
