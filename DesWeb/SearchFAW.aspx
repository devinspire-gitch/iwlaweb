...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
 ...
 runat="server" /><b> Request for Information</b><br /><br /><br /><br />
                                      <a  href='<%# "Mail.aspx?company=" + DataBinder.Eval(Container.DataItem, "Name")  %>'> E-Mail</a>
                                    
                                    <br />
                                    <a  href='<%# "DetailsHD.aspx?company=" + DataBinder.Eval(Container.DataItem, "Name")  %>'>
                                        <%--<img src='<%#  DataBinder.Eval(Container.DataItem, "IWLALogoonWebsite")  %>' alt='<%#  DataBinder.Eval(Container.DataItem, "Name")  %>' style='width:150px!important;'/>--%>
