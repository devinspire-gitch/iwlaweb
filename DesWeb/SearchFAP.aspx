<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchFAP.aspx.cs" Inherits="DesWeb.SearchFAP" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <ItemTemplate>
                            ...
                            <div class="row  srch-res-l">
                                <div class="col-lg-8">  
                                    ...
                                    <h2><a  href=' <%# "Details.aspx?company=" + DataBinder.Eval(Container.DataItem, "Name")  %>'><%# DataBinder.Eval(Container.DataItem, "Name") %></a></h2>
 ...
 runat="server" /><b> Request for Information</b><br /><br /><br /><br />
                                    <a href="Mail.aspx" class="website">E-mail</a>
